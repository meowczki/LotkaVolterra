...
public class LotkaVolterra2ODE implements FirstOrderDifferentialEquations {
    private double [] params;

    public LotkaVolterra2ODE(double[] params) {
        this.params = params;
    }
    ...
    public void computeDerivatives(double t, double[] x, double[] dxdt) throws MaxCountExceededException, DimensionMismatchException {
        ...
        dxdt[1]=(params[2]*x[0]-params[3])*x[1]-params[5]*x[0];
    }
}
